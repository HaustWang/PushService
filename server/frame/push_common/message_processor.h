...
public:
    ...
    int FillMsgHead(SvrMsgHead* head, const SvrMsgType type, const int dst_svr_type, const SvrMsgHead* src_head = NULL, const std::string& client_id = "", const std::string& appid = "");
